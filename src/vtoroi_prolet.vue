...
<script>
  ...
  export default {
    ...
    methods: {
      on() {
        eventEmitter.$emit('button_2_on')
      },
      off() {
        eventEmitter.$emit('button_2_off')
      },
      reset() {
